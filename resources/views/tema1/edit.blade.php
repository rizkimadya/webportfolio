    ...
    <section id="dashboard">
        <div class="row">
            ...
            <div class="col-10">
                <div class="card2">
                    <div class="card">
                        <h4 class="p-4">Update <span style="color: #57B5E0;">Portfolio</span></h4>
                    </div>
                    
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="card p-4">
                                <form action="{{ route('update.tema', ['id' => $tema->id]) }}"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mt-3">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            data-bs-target="#datapribadi" aria-expanded="false"
                                                            aria-controls="datapribadi">
                                                            Data Pribadi
                                                        </button>
                                                    </h2>
                                                    <div id="datapribadi" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" type="text" name="pekerjaan" id="pekerjaan" placeholder="masukkan pekerjaan" value="{{ $tema->pekerjaan }}">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                alt="" class="d-block mb-3">
                                                                <input type="file" name="foto" id="foto" class="form-control">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="alamat" class="form-label">Alamat Sekarang</label>
                                                                <textarea name="alamat" id="alamat" rows="8" placeholder="Masukkan alamat anda" class="form-control">{{ $tema->alamat }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" name="no_wa" id="no_wa"
                                                                    placeholder="Masukkan Nomor Wa/Hp" class="form-control" value="{{ $tema->no_wa }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="nama_ig" class="form-label">Nama Instagram</label>
                                                                <input type="text" name="nama_ig" id="nama_ig"
                                                                    placeholder="Masukkan Nama Instagram" class="form-control" value="{{ $tema->nama_ig }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="email" class="form-label">Email</label>
                                                                <input type="email" name="email" id="email"
                                                                    placeholder="Masukkan Email anda" class="form-control" value="{{ $tema->email }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="hobi1" id="hobi1"
                                                                    placeholder="Masukkan Hobi anda" class="form-control" value="{{ $tema->hobi1 }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="hobi2" class="form-label">Hobi 2</label>
                                                                <input type="text" name="hobi2" id="hobi2"
                                                                    placeholder="Masukkan Hobi anda" class="form-control" value="{{ $tema->hobi2 }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="hobi3" class="form-label">Hobi 3</label>
                                                                <input type="text" name="hobi3" id="hobi3"
                                                                    placeholder="Masukkan Hobi anda" class="form-control" value="{{ $tema->hobi3 }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion mt-3" id="accordionPanelsStayOpenExample">
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="moto" class="accordion-collapse collapse"
                                                        aria-labelledby="panelsStayOpen-headingTwo">
                                                        <div class="accordion-body">
                                                            <textarea name="moto" id="moto" rows="10" placeholder="Masukkan moto anda" class="form-control">{{ $tema->moto }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
